/-
  ...
  | — | C09 | Hecke/Langlands transfer               | OPEN: P5_HeckeTransfer_14 |
  ...
  ## Part 1 — OPEN surface: `M_ZetaControl_Surface`

  Aliases `P5_HeckeTransfer_14` as the named "main theorem surface".
  ...
  The terminal conditional combinator. Given `M_ZetaControl_Surface`
  (= `P5_HeckeTransfer_14`), derives `_root_.RiemannHypothesis` by
  ...
  * `P5_HeckeTransfer_14` is vacuously satisfiable if RiemannHypothesis
...
/-- **Main theorem open surface alias.**
    ...
    are discharged.  Aliases `P5_HeckeTransfer_14` from C09 under the
    name "M_ZetaControl_Surface" so that the main-theorem combinator's
...
def M_ZetaControl_Surface : Prop :=
  P5_HeckeTransfer_14
...
/-- **Main theorem: zeros of ζ(s) controlled by X₀(143). (NOT a brick)**
    ...
    *Statement:* Given the Hecke/Langlands transfer `hM`
    (= `P5_HeckeTransfer_14`, the single remaining open surface),
...
/- The five proved bricks of the C01–C10 chain (collected for reference).
    ...
    Plus one open surface: `P5_HeckeTransfer_14` (= M_ZetaControl_Surface).
