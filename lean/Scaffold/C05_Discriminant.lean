/-
  ...
  Recorded as a named OPEN surface: `DiscriminantBound_X0_143`.
  In chain terms this is one arithmetic-geometry component of the single
  remaining open surface `P5_HeckeTransfer_14` (C09).
...
/-- **Arakelov discriminant-conductor bound for X₀(143) — OPEN surface.**
    ...
    Bost–Connes / Langlands descent (C09, `P5_HeckeTransfer_14`).

    This is an arithmetic-geometry sub-step of `M4_ExceptionalWeilBridge`
    (C08) and `P5_HeckeTransfer_14` (C09).  It names the discriminant-
...
def DiscriminantBound_X0_143 : Prop :=
