/-
  ...
  Recorded as a named OPEN surface: `VojtaHeightBound_X0_143`.
  In chain terms this is one arithmetic component of the single remaining open
  surface `P5_HeckeTransfer_14` (C09).
...
/-- **Vojta-Faltings height bound for X₀(143) — OPEN surface.**
    ...
    Bost–Connes / Langlands analytic descent (C09, `P5_HeckeTransfer_14`).

    This is an arithmetic sub-step of `M4_ExceptionalWeilBridge` (C08)
    and `P5_HeckeTransfer_14` (C09).  It names the height-bound component
    of that gap.

    STATUS: OPEN.  NOT a brick.  DO NOT discharge with `trivial` or `sorry`. -/
def VojtaHeightBound_X0_143 : Prop :=
