/-
  ...
  Recorded as a named OPEN surface: `Modularity_X0_143`.
...
/-- **Modularity of X₀(143) — OPEN surface.**
    ...
    This is a sub-step of `M4_ExceptionalWeilBridge` (C08) and
    `P5_HeckeTransfer_14` (C09).  It names the automorphic-lift
    component of that gap.

    STATUS: OPEN.  NOT a brick.  DO NOT discharge with `trivial` or `sorry`. -/
def Modularity_X0_143 : Prop :=
