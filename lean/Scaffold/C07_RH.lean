/-
  ...
  * `hbridge : ArakelovPositivity (X₀ 143) → RiemannHypothesis`  — open;
  ...
  • C02: Modularity_X0_143  (named OPEN surface — automorphic lift gap)
  • C03: slope_inequality    (GENUINE: (4g-4)/g ≤ ω² from arakelov def)
  • C04: VojtaHeightBound_X0_143  (named OPEN surface — height bound gap)
  • C05: DiscriminantBound_X0_143 (named OPEN surface — discriminant gap)
  • C06: bost_connes_threshold (GENUINE BRICK: 2√13 < 320)
  • C06: ZetaZerosCriticalLine (named OPEN surface — GRH descent gap)
