...
theorem route_b_master_reduction
    ...
    (L_sym2_143         : C -> C)
    -- BC6 sub-opens
    (h_bc6_sm  : BC6_SelbergMatch S_weil S_spectral)
    (h_bc6_sp  : BC6_SpectralBC95 S_spectral arakelov_pairing)
    -- Gate M2 sub-opens
    (h_fe_rn   : FE_CompletedFunctionalEq DirichChar_143 twistedL_143a1)
    (h_ep_ram  : EP_RamanujanBound L_143a1)
    (h_ep_pnz  : EP_ProductNonzero L_143a1)
    (h_bs_pl   : BS_PhragmenLindelof DirichChar_143 twistedL_143a1)
    (h_bs_vt   : BS_VerticalBoundary DirichChar_143 twistedL_143a1)
    (h_cu_cp   : CU_ConverseHalfPlane DirichChar_143 newform_143a1_L twistedL_143a1 L_143a1)
    (h_cu_ext  : CU_ExtendToAllC newform_143a1_L L_143a1)
    (h_ef      : ExplicitFormula_AtomicGap L_143a1 S_weil)
    (h_wg      : WG_ZeroDensity newform_143a1_L L_143a1)
    -- Gate M3 sub-opens
    (h_rs_id   : RS_EulerFactorIdentity RankinSelberg_L L_sym2_143)
    (h_ik_sp   : IK_RS_SimplePole RankinSelberg_L L_sym2_143)
    (h_ik_gnv  : IK_GRH_to_L_sym2_nv RankinSelberg_L L_sym2_143)
    (h_ik_lk   : IK_RS_L143_Link RankinSelberg_L L_sym2_143 L_143a1)
    (h_zfr_dv  : ZFR_DelaValleePoussin L_143a1)
    (h_zfr_rh  : ZFR_RHFromWeilZeroFree L_143a1)
    -- Wall C sub-opens
    (h_stir_b  : Stirling_Binet)
    (h_stir_r  : forall sl sh, Stirling_Remainder sl sh)
